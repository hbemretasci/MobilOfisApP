...
class PostMessage @Inject constructor(
    ...
    operator fun invoke(gib: String, sender: String, receiver: String, message: String, onResult: (Throwable?) -> Unit) {
        val messageItem = MessageDto(message, receiver, sender, false, Timestamp.now())
